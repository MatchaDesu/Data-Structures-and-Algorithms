...
def selectionSort(unOrderedList, lastIndex) :
    ...
    while current <= lastIndex :
        ...
        while walker <= lastIndex :
            if unOrderedList[walker][0] < unOrderedList[smallest][0] or (unOrderedList[walker][0] == unOrderedList[smallest][0] and int(unOrderedList[walker][1:]) < int(unOrderedList[smallest][1:])) :
                smallest = walker
            walker += 1
            compareTime += 1
